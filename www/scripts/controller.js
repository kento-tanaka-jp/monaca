(function() {
    ...
    app.controller('YobouController', function($scope, $timeout){
        $timeout(function(){
            loadTextFile();
        });
    });
    ...
    app.controller('MapController', function($scope, $timeout){
        ...
        $timeout(function(){
            ...
            var latlng = new google.maps.LatLng(33.951509, 131.246786);
            var myOptions = {
                zoom: 16,
                center: latlng,
            ...
            $scope.addBabysStationMarkers();
            $scope.getLocation();
            
        },100);
        
        //Add Akachan-no-eki Markers
        $scope.addBabysStationMarkers = function(){
            obj = JSON.parse(akaekiJSON);
        ...
        $scope.getLocation = function(){
            if(navigator.geolocation){
                navigator.geolocation.getCurrentPosition($scope.succeededGettingLocation);
            }
        }
        
        $scope.succeededGettingLocation = function(pos){
        ...
        $scope.calculateDistance = function(){
            ...
            if($scope.markers.length < 2){
                ...
                for(var i = 0; i < partialDistance.length; i++){
                    ...
                    var R = 6378137; // Earth窶冱 mean radius in meter
